...
describe('decodeSingle', () => {
    ...
    function _runTestSet(testSet, config) {
        ...
        it(`should decode ${folder} correctly`, done => {
            eachSeries(testSet, (sample, callback) => {
    ...
    describe('EAN', () => {
        const config = { ...defaultConfig, decoder: { readers: ['ean_reader'] } };
        const testSet = [
    ...
    describe('Code39', () => {
        const config = { ...defaultConfig, decoder: { readers: ['code_39_reader'] } };
        const testSet = [
    ...
    describe('EAN-8', () => {
        const config = { ...defaultConfig, decoder: { readers: ['ean_8_reader'] } };
        const testSet = [
    ...
    describe('UPC', () => {
        const config = { ...defaultConfig, decoder: { readers: ['upc_reader'] } };
        const testSet = [
    ...
    describe('UPC-E', () => {
        const config = { ...defaultConfig, decoder: { readers: ['upc_e_reader'] } };
        const testSet = [
    ...
    describe('Codabar', () => {
        const config = { ...defaultConfig, decoder: { readers: ['codabar_reader'] } };
        const testSet = [
