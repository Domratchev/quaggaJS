...
const CHARACTER_ENCODINGS = [0x034, 0x121, 0x061, 0x160, 0x031, 0x130, 0x070, 0x025, 0x124, 0x064, 0x109, 0x049,
...
export class Code39Reader extends BarcodeReader {
    ...
    _verifyTrailingWhitespace(lastStart, nextStart, counters) {
    ...
    _findNextWidth(counters, current) {
